...
<div style="display: flex; justify-content: space-between; gap: 1rem; text-align: center;">
  ...
  <div style="flex: 1;">
    <img src="pic/hills1.jpg" alt="Risnjak" style="width: 100%;">
    <p style="font-size: 0.9em; color: gray;">Risnjak</p>
  </div>

  <div style="flex: 1;">
    <img src="pic/velebit.jpg" alt="Velebit" style="width: 100%;">
    <p style="font-size: 0.9em; color: gray;">Pohled na Velebit</p>
  </div>
...
<div style="text-align: center;">
  <img src="pic/lublan.jpg" alt="Lublan" style="width: 60%;">
  <p style="font-size: 0.9em; color: gray;">Lublaň shora</p>
</div>
...
<div style="text-align: center;">
  <img src="pic/snemovej_ohen.jpg" alt="Snem" style="width: 50%;">
  <p style="font-size: 0.9em; color: gray;">Sněmovej oheň</p>
</div>
